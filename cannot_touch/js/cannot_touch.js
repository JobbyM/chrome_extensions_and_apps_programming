function btn_move(el, mouseLeft, mouseTop){
  ...
  var btnLeft = mouseLeft + (leftRnd>0?102:-102) + leftRnd;
  var btnTop = mouseTop + (topRnd>0?38:-38) + topRnd;
...
document.getElementById('s_btn_wr').addEventListener('mouseover', over_btn, false);
